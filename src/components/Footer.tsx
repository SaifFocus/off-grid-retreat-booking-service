        ...
        <div className="flex flex-col gap-10 lg:gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 mb-8">
              <a href="mailto:saifinquiry@gmail.com" className="text-background/70 hover:text-background smooth-hover text-xs font-light flex items-center gap-2">
                <Mail className="h-3 w-3" />
                saifinquiry@gmail.com
              </a>
